...
import 'learn_provider/2_change_notifier_provider/view_model_2.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    ///
    /// Provider ,这种Provider数据改变后，页面并不会刷新
    ///
    ...
    ///
    /// ChangeNotifierProvider ,这种Provider数据改变后，页面也发生改变
    ///
    // return ChangeNotifierProvider<ViewModel2>(
    //   create: (context) => ViewModel2(),
    //   child: MaterialApp(
    //     debugShowCheckedModeBanner: true,
    //     home: ProviderPage3(),
    //   ),
